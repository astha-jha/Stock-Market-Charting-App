...
import com.example.astha.services.UserService;
...
public class UserController {
	...
	public ResponseEntity<Void> Stringreactuserapi(@RequestBody Users user) throws AddressException, MessagingException {
		...
		usersRepository.getById(user.getId());
	...
	public void sendemail(Long userid) throws AddressException, MessagingException {
		...
		final String username = "majorproject402@gmail.com";
		final String password = "Coughvid@123";
		...
		try {
			...
			message.setFrom(new InternetAddress("majorproject402@gmail.com"));
